...
class M_Clients extends MY_Model {
	...
	function getUser() {
       ...
       //Working with an object of the entity
		$user = $this->em->getRepository('models\Entities\entities_254\E_Clients')
						->findOneBy(array('Client_Email' => $this -> input -> post('email'), 'Client_Password' => $this -> input -> post('password')));
