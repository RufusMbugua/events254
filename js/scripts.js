...
$().ready(function() {
	$('.event.anniversary').hide();
	$('.event.birthdays').hide();
	$('.event.corporate').hide();
	$('.event.party').hide();
	$('.event.teambuilding').hide();
	$('.event.weddings').hide();
	
	$('.event-title.birthdays').click(function() {
	$('.event.anniversary').hide();
	$('.event.birthdays').show();
	$('.event.corporate').hide();
	$('.event.party').hide();
	$('.event.teambuilding').hide();
	$('.event.weddings').hide();
	...
	$('.event-title.corporate').click(function() {
		$('.event.anniversary').hide();
	$('.event.birthdays').hide();
	$('.event.corporate').show();
	$('.event.party').hide();
	$('.event.teambuilding').hide();
	$('.event.weddings').hide();
	});
	
		$('.event-title.party').click(function() {
		$('.event.anniversary').hide();
	$('.event.birthdays').hide();
	$('.event.corporate').hide();
	$('.event.party').show();
	...
	$('.event.weddings').hide();
		...
		$('.event-title.teambuilding').click(function() {
		$('.event.anniversary').hide();
	$('.event.birthdays').hide();
	$('.event.corporate').hide();
	$('.event.party').hide();
	$('.event.teambuilding').show();
	$('.event.weddings').hide();
	});
	
		$('.event-title.weddings').click(function() {
		$('.event.anniversary').hide();
	$('.event.birthdays').hide();
	$('.event.corporate').hide();
	$('.event.party').hide();
	...
	$('.event.weddings').show();
			...
			$('.event-title.anniversary').click(function() {
		$('.event.anniversary').show();
	$('.event.birthdays').hide();
	$('.event.corporate').hide();
	$('.event.party').hide();
	$('.event.teambuilding').hide();
